...
int main(int argc, char const *argv[]) {
  ...
  int valor1=0, valor2=1, valor3=2, valor4=3;
  pthread_create(&p_threads[valor1], NULL, producto, &valor1);
  pthread_create(&p_threads[valor2], NULL, producto, &valor2);
  pthread_create(&p_threads[valor3], NULL, producto, &valor3);
  pthread_create(&p_threads[valor4], NULL, producto, &valor4);
